...
<section class="forms">
    <div class="container-fluid">
        ...
        {{-- ================= PAY FORM ================= --}}
        <form id="pay-commissions-form"
            method="POST"
            action="{{ route('biller.commissions.pay') }}">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="9" class="text-center">
                                {{__('No commissions found for this date')}}
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
...
<script>
    $(function() {
        ...
        $('.commission-checkbox').on('change', function() {
            ...
            $('#select-all').prop(
                'checked',
                $('.commission-checkbox:checked').length ===
                $('.commission-checkbox').length
            );
        });
    ...
    function confirmPayment() {
        ...
        return confirm(
            `Pay ${count} commission(s) with total amount: ${amount}?`
        );
    }
</script>
@endpush