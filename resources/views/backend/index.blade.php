...
<style>
    ...
    .dashboard-counts .count-title span::before {
        line-height: 1;
    }
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="right-column">
                            <div class="badge badge-primary">{{ __('db.top') }}</div>
                        </div>
                    </div>
                    <div class="table-responsive">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="right-column">
                            <div class="badge badge-success">{{ __('db.top') }} </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table id="yearly-best-selling-qty" class="table">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>{{ __('db.Expense by Category') . ' ' . date('Y') }}</h4>
                        <div class="right-column">
                            <div class="badge badge-danger">{{ __('db.top') }}</div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table">
